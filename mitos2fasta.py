...
def get_args():
    parser = argparse.ArgumentParser(prog = "mitos2fasta.py", usage = "mitos2fasta.py --mitofile My_mitogenome_sequence.fas --genefile My_mitos2_genes.fas --convertfile Y/N > My_assembly.fas", description = "Description: align genes to mitogenome sequence reference. Type on terminal mitos2fasta.py -h for further information")
