...
def get_args():
    parser = argparse.ArgumentParser(prog = "mitos2fasta.py", usage = "mitos2fasta.py -m mitofile.fas -g genesfile.fas -c convertfile_Y/N > assembly.fas", description = "Description: align (map) genes to mitogenome sequence. Type on terminal mitos2fasta.py -h for further information or visit https://github.com/IMEDEA/mitogenomics")
